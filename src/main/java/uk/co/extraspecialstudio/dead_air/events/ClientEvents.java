 ...
 */
@EventBusSubscriber(modid = Dead_air.MODID, bus = EventBusSubscriber.Bus.GAME, value = Dist.CLIENT)
...
public class ClientEvents {
    ...
    @SubscribeEvent
    public static void onClientDisconnecting(net.neoforged.neoforge.client.event.ClientPlayerNetworkEvent.LoggingOut event) {
        DISCONNECTING = true;
        try {
            AudioManager.stopAll();
    ...
    @SubscribeEvent
    public static void onClientTickKeybind(ClientTickEvent.Post event) { 
