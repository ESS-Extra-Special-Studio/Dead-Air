...
public class MusicStationManager {
    ...
    public static void initialize() {
        ...
        if (jukebox != null && !jukebox.isEmpty()) {
            ...
            for (SoundEvent ev : net.minecraft.core.registries.BuiltInRegistries.SOUND_EVENT) {
                ResourceLocation id = net.minecraft.core.registries.BuiltInRegistries.SOUND_EVENT.getKey(ev);
