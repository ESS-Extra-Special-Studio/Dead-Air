...
public class StationRegistry {
    ...
    public static void registerDefaultStations() {
        ...
        uk.creatopia.unbound.dead_air.events.StationRegistrationEvent event = 
            new uk.creatopia.unbound.dead_air.events.StationRegistrationEvent();
        ...
        int musicRange = Config.musicStationRange > 0 ? Config.musicStationRange : 1500;
        ...
        // Zombiecraft Radio - Zombiecraft mod music (common for infected/overrun towers)
        registerStation(new RadioStation(
    ...
    private static void clearDynamicStations() {
        ...
        Dead_air.LOGGER.info("Cleared dynamic stations, keeping {} default stations", STATION_LIST.size());
    }
}
